...
public class SolicitudController {
    ...
    // Los estados de las solicitudes son 0 -> CREADA , 1 -> ACEPTADA, 2->RECHAZADA y 3-> CANCELADA
    ...
    @PutMapping("rechazar/{id_solicitud}")
    public ResponseEntity<String> rechazarSolicitud(@PathVariable int id_solicitud) {
        return (new ResponseEntity<>(solicitudService.rechazarSolicitud(id_solicitud), HttpStatus.OK));
    }
}
